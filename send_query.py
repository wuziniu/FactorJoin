...
if __name__ == '__main__':
    ...
    parser.add_argument('--method_name', help='the saved estimates')
    parser.add_argument('--query_file', default='job_queries/all_queries_original.sql',
                        help='Query file location')
    parser.add_argument('--save_folder', default='job_queries/results', help='Query file location')
